...
def unknown() -> str:
    """Produces a random response when the input is unknown

        Returns:
            A formated string containing the unknown response

        .. impl::
            :id: UNKNOWN
            :implements: REQ_13
        """
    response: str = ['response | Could you please re-phrase that?',
